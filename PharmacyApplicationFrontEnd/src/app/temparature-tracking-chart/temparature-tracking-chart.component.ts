...
export class TemparatureTrackingChartComponent implements OnInit {
  ...
  refreshMedicineList(){
    ...
    this.medicineById = new AvailableMedicineList(this.id, '', new Date(), false,null,false,2,8)
  ...
  handleResponse(response: any) {
    this.maxTemp=response.maxTemp;
    this.minTemp=response.minTemp;
...
console.log(this.tempData)
  ...
  for(let i=0; i<this.tempCurrentTemp.length; i++){
    ...
    if(this.tempCurrentTemp[i]>this.maxTemp || this.tempCurrentTemp[i]<this.minTemp) {
      console.log(this.tempCurrentTemp[i]>this.maxTemp )
      console.log(this.minTemp+"///////////////////"+this.maxTemp+"///////////////////"+this.tempCurrentTemp[i])
      console.log(this.tempCurrentTemp[i]>this.minTemp )
